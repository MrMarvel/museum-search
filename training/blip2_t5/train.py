...
class DataTrainingArguments:
    ...
    data_cache_dir: Optional[str] = field(default=None, metadata={"help": "The data directory containing cached files."})
...
def main():
    ...
    model = VisionTextDualEncoderModel.from_pretrained(
        model_args.model_name_or_path,
        config=VisionTextDualEncoderConfig.from_pretrained(model_args.model_name_or_path),
